...
contract TestICS04Upgrade is ICS04UpgradeTestHelper, ICS04PacketEventTestHelper {
    ...
    function testUpgradeInit() public {
        ...
        );
        {
            ...
            IIBCChannelUpgrade.MsgChannelUpgradeInit memory msg_ = IIBCChannelUpgrade.MsgChannelUpgradeInit({
                ...
                proposedUpgradeFields: mockApp.getAuthorizedUpgrade(channel0.portId, channel0.channelId).fields
            });
            vm.expectRevert();
    ...
    function testUpgradeOutOfSync() public {
        ...
        assertEq(
            mockApp.authorizeAndInitUpgrade(
                channel0.portId,
                channel0.channelId,
                UpgradeFields.Data({
        ...
        );
        {
            ...
            IIBCChannelUpgrade.MsgChannelUpgradeTry memory msg_ = IIBCChannelUpgrade.MsgChannelUpgradeTry({
                portId: channel0.portId,
                channelId: channel0.channelId,
                counterpartyUpgradeFields: mockApp.getAuthorizedUpgrade(channel1.portId, channel1.channelId).fields,
    ...
    function testUpgradeCrossingHelloIncompatibleProposals() public {
        ...
        }
        {
            IIBCChannelUpgrade.MsgChannelUpgradeTry memory msg_ = IIBCChannelUpgrade.MsgChannelUpgradeTry({
                portId: channel1.portId,
                channelId: channel1.channelId,
                counterpartyUpgradeFields: mockApp.getAuthorizedUpgrade(channel0.portId, channel0.channelId).fields,
                counterpartyUpgradeSequence: 1,
                proposedConnectionHops: new string[](0),
                proofs: upgradeLocalhostProofs()
            });
    ...
    function handshakeUpgradeWithCallbacks(
            ...
            assertEq(
                ibcHandler.channelUpgradeInit(
                    IIBCChannelUpgrade.MsgChannelUpgradeInit({
                        portId: channel1.portId,
                        channelId: channel1.channelId,
                        proposedUpgradeFields: mockApp.getAuthorizedUpgrade(channel1.portId, channel1.channelId).fields
                    })
                ),
                upgradeSequence
            );
        ...
        if (flow.fastPath && !skipFlushCompleteAuthorization) {
            ...
            mockApp.authorizeUpgradeTransitionToFlushComplete(channel0.portId, channel0.channelId, upgradeSequence);
            mockApp.authorizeUpgradeTransitionToFlushComplete(channel1.portId, channel1.channelId, upgradeSequence);
        }
    ...
    {
        return Upgrade.Data({
            fields: mockApp.getAuthorizedUpgrade(portId, channelId).fields,
            timeout: mockApp.getAuthorizedUpgrade(portId, channelId).timeout,
